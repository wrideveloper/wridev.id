...
const baseClasses =
	"relative font-sans font-normal inline-flex items-center justify-center tw-accessibility transition-all duration-300 h-12 px-5 py-3 text-sm";
...
<a href={to} class={selectedClassName}>
	<slot />
</a>
