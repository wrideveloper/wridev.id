...
<div class="px-2">
	...
	<div class="pb-10 border-b border-muted-200 dark:border-muted-800">
		<h3 class="font-sans font-light text-lg mb-6 text-muted-800 dark:text-muted-100">Availability</h3>
		<!--Select-->
	...
	<div class="pt-6 pb-10 border-b border-muted-200 dark:border-muted-800">
		<h3 class="font-sans font-light text-lg mb-6 text-muted-800 dark:text-muted-100">Location</h3>
		<div class="space-y-4">
			<div class="flex items-center gap-3 cursor-pointer">
				...
				<label for="radio-0" class="ml-2 text-sm leading-4 font-normal text-muted-800 dark:text-muted-400">
					All locations
				</label>
			</div>
			<!--Radio Option-->
			<div class="flex items-center gap-3 cursor-pointer">
				...
				<label for="radio-1" class="ml-2 text-sm leading-4 font-normal text-muted-800 dark:text-muted-400">
					Same town
				</label>
			</div>
			<!--Radio Option-->
			<div class="flex items-center gap-3 cursor-pointer">
				...
				<label for="radio-2" class="ml-2 text-sm leading-4 font-normal text-muted-800 dark:text-muted-400">
					Same country
				</label>
			</div>
			<!--Radio Option-->
			<div class="flex items-center gap-3 cursor-pointer">
				...
				<label for="radio-3" class="ml-2 text-sm leading-4 font-normal text-muted-800 dark:text-muted-400">
					Other countries
				</label>
			</div>
		</div>
	...
	<!--Filter group-->
	<div class="pt-6 pb-10 border-b border-muted-200 dark:border-muted-800">
		<h3 class="font-sans font-light text-lg mb-6 text-muted-800 dark:text-muted-100">Consultation type</h3>
		<!--Radio options-->
		<div class="space-y-4">
			<!--Radio Option-->
			<div class="flex items-center gap-3 cursor-pointer">
				...
				<label for="radio-4" class="ml-2 text-sm leading-4 font-normal text-muted-800 dark:text-muted-400">
					Video call
				</label>
			</div>
			<!--Radio Option-->
			<div class="flex items-center gap-3 cursor-pointer">
				...
				<label for="radio-5" class="ml-2 text-sm leading-4 font-normal text-muted-800 dark:text-muted-400">
					Audio call
				</label>
			</div>
		</div>
	...
	<!--Filter group-->
	<div class="pt-6 pb-10 border-b border-muted-200 dark:border-muted-800">
		<h3 class="font-sans font-light text-lg mb-6 text-muted-800 dark:text-muted-100">Experience</h3>
		<!--Radio options-->
		<div class="space-y-4">
			<!--Radio Option-->
			<div class="flex items-center gap-3 cursor-pointer">
			...
			<div class="flex items-center gap-3 cursor-pointer">
				...
				<label for="radio-7" class="ml-2 text-sm leading-4 font-normal text-muted-800 dark:text-muted-400">
					10+ years
				</label>
			</div>
			<!--Radio Option-->
			<div class="flex items-center gap-3 cursor-pointer">
				...
				<label for="radio-8" class="ml-2 text-sm leading-4 font-normal text-muted-800 dark:text-muted-400">
					15+ years
				</label>
			</div>
		</div>
