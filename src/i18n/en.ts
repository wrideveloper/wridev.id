export const en = {
  ...
  talentmodal: {
    title_1: "Find",
    title_accent_1: "Great",
    title_accent_2: "Talent",
    for: "for",
    title_2: "Professional Work",
    step_1: "Step 1",
    step_2: "Step 2",
    step_3: "Step 3",
    step_4: "Step 4",
    label_company: "Company/Organization Name",
    ph_company: "e.g. WRI Polinema",
    err_required: "The field is required!",
    label_email: "Email Address",
    ph_email: "e.g. finding.talent@gmail.com",
    label_prof: "Proficiency",
    ph_prof: "Select talent proficiency",
    err_prof: "Please select a proficiency",
    ...
    processing_desc: "Please wait while we send your request.",
